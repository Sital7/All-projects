...
// //             const categoryDiv = document.createElement("div");
// //             categoryDiv.classList.add("category-container");
// //             categoryDiv.id = `${category.toLowerCase().replace(/ & /g, '-').replace(/\s/g, '-')}-expenses`; // unique ID for each category section
...
// //             if (categoryDiv) {
// //                 // Toggle visibility of the category section
// //                 const currentDisplay = categoryDiv.style.display;
// //                 categoryDiv.style.display = currentDisplay === "none" || currentDisplay === "" ? "block" : "none";
// //             }
// //         });
// //     });
...
// //             categoryDiv.classList.add("category-container");
// //             categoryDiv.id = `${category.toLowerCase().replace(/ & /g, '-').replace(/\s/g, '-')}-expenses`; // unique ID for each category section
// //             categoryDiv.style.display = "none";  // Hide each category initially
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    showAllExpensesButton.addEventListener("click", () => {
        // Toggle the display of the expense list and total when clicked
        if (expenseList.style.display === "none") {
            expenseList.style.display = "block";
            totalExpense.style.display = "block"; // Display total expense as well
            showAllExpensesButton.textContent = "Hide All Expenses";
        } else {
            expenseList.style.display = "none";
            totalExpense.style.display = "none";
            showAllExpensesButton.textContent = "Show All Expenses";
        }
    });
...
//         // Render the expenses for the clicked category
//         categoryButtons.forEach(button => {
//             const category = button.dataset.category;
//             const categoryDiv = document.getElementById(`${category.toLowerCase()}-expenses`);
...
//                 categoryDiv.appendChild(categoryTitle);
//                 categoryDiv.appendChild(categoryTable);
//                 categoryDiv.style.display = "block"; // Show this category section
//             }
//         });
//     }
...
//             // Toggle visibility of the clicked category section
//             if (categoryDiv) {
//                 const currentDisplay = categoryDiv.style.display;
//                 categoryDiv.style.display = currentDisplay === "none" || currentDisplay === "" ? "block" : "none";
//             }
